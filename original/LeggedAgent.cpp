...
void LeggedAgent::StepCPG(double StepSize, double performance, RandomState &rs, int learning)
{
	double force = 0.0;
...
void LeggedAgent::Step1RPG(double StepSize, double performance, RandomState &rs, int learning)
{
	double force = 0.0;
